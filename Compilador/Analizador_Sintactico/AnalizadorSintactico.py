...
"""
1. SALVO EL...(Como manejamos el !??)
2. atomica incremental decremental ++ -- 
...
def validar_condicion(raiz, inicial,final):
    hijos = raiz.hijos[inicial:final + 1]
    estructura = [['IDENTIFICADOR','COMPARACIÓN','CONDICIÓN'], ['OPERADOR LÓGICO'], ['IDENTIFICADOR','COMPARACIÓN','CONDICIÓN']]
    estructuraB = [['OPERADOR LÓGICO'],['IDENTIFICADOR','COMPARACIÓN','OPERADOR LÓGICO','CONDICIÓN']]
...
def validar_argumento(raiz, inicial, final):
    ...
    estructura = [['IDENTIFICADOR', 'NUMERO ENTERO', 'NUMERO FLOTANTE', 'DECLARACIÓN VARIABLE/PARAMETROS'], ['CARÁCTER PUNTUACIÓN']]
